import type { JSX } from 'https://esm.sh/react';
import type { ElementIconProps } from './types.ts';

export const Pyro = ({ size = 64, color = '#F8AA75', ...props }: ElementIconProps): JSX.Element => (
    <svg
